...
const Footer = () => {
  return (
    <footer className="max-conatainer">
     ...
     flex-wrap max-lg:flex-col">
      ...
      items-start">
        ...
        <p className="mt-6 text-baseleading-7 font-montserrat text-white-400 
        sm:max-w-sm ">Get shoes ready for the new term at your nearest Nike stpre. Find your perfect size in store. Get rewards </p>
      ...
      max-sm:items-center">
        <div className="flex flex-1 justify-start items-center font-montserrat cursor-pointer">
            ...
            />
            <p className="m-10">Copyright: All rights reserved</p>
        </div>
        <p className="font-montserrat cursor-pointer m-10">Terms & Conditions </p>
      </div>
    </footer>
  )
}
