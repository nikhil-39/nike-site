...
const Hero = () => {
  ...
  return (
    <section id="home" className="w-full 
     flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-conatiner ">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl-pading-x pt-28">
        ...
        leading-8 mt-6 mb-14 sm:max-w-sm">
          Discover stylih Nike 
          arrival, quality comfort,
          and innovation for
          your active life .
        </p>
      ...
      flex justify-center items-center xl:min-h-screenmax-xl:py-40
